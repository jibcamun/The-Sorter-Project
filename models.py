...
class SorterAction(Action):
    ...
    segment: List[Tuple[int, int, int, bool]] = Field(default_factory=list)
...
class SorterObservation(Observation):
    ...
    positions_segment: Dict[str, Tuple[int, int, int, bool]] = Field(default_factory=dict)
    positions_adjust: Dict[str, Tuple[int, int, int, bool]] = Field(default_factory=dict)
